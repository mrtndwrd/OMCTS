...
does, the algorithm could probably increase sturdiness. \todo{Other search
heuristics, like the one in General Video Game Playing with Goal
Orientation(goalOrientationPlanningHeuristicsThesis.pdf)}
