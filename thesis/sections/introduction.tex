...
A limitation in current general video game playing research, is that many games
...
In this paper a new algorithm, called \emph{option MCTS (O-MCTS)} is introduced
