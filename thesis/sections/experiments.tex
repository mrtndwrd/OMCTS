...
\section{A Simple Game}
For testing purposes, we create a very simple game with the avatar and one NPC.
When the avatar walks into the NPC, it dies and the avatar wins the game. 
