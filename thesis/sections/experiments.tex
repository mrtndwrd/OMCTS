...
\begin{enumerate}
	...
	\item Digdug:
		...
		avatar presses USE in two consecutive time steps, it shoots a boulder to
		kill the enemy.
	...
	\item Eggomania:
		...
		the game.
	\item Portals:
		The avatar needs to find the exit of the maze. When he enters a portal,
		he appears at another portal. The aim of the game is to find the correct
		sequence of portals that lead to the exit.
	\item Frogs:
